...
Remaining allocation (of 20 pre-credit calls): probe/fixture 1 of 3 left, webhook test 1 of 2 left, real-call validation 6, demo takes 6, reserve 3. The ~200 promotional credits extend real-call validation only, not this logging rule.
